...
% which by the way are not provided to this function. Notice that we're talking about the mean over data cases (as opposed to the sum over data cases).
    N_ = size(visible_state, 2);
    d_G_by_rbm_w = hidden_state * visible_state' / N_;
end
